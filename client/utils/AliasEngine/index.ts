...
/**
 * Tries to match input against aliases. If matched, expands the command with capture groups.
 * Returns array of commands (split by newlines) or null if no match.
 */
